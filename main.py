...
def display_image(category):
    try:
        url = f"https://api.unsplash.com/photos/random?query={category}&orientation=landscape&client_id=l0lG21ZGNVKhgflq0WlgCvmkEmeum5p5gmNGPJi5sdA"
...
def create_gui():
    ...
    category_options = ["Choose Category", "Food", "Animals", "People", "Music", "Art", "Vehicles", "Abstract", "Forest", "Fog", "Space", "Galaxy", "Waterfall", "Rainfall", "Flowers", "Random", "coding", "gaming", "hacking"]
